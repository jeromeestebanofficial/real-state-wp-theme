<?php
add_action('after_switch_theme', 'estatein_theme_create_menu_and_flush');
function estatein_theme_create_menu_and_flush() {
...
// Redirect /home to /
// -----------------------------
add_action('template_redirect', 'estatein_theme_redirect_home_slug');
function estatein_theme_redirect_home_slug() {
