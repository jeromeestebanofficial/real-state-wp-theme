...
<stop offset="0.576615" stop-color="#A685FA" stop-opacity="0"/>
                ...
                <h3 class="feature-title">
                    <?php echo esc_html(get_theme_mod('feature_1_title', 'Find Your Dream Home')); ?>
                </h3>
            </div>
...
<stop offset="0.576615" stop-color="#A685FA" stop-opacity="0"/>
                ...
                <h3 class="feature-title">
                    <?php echo esc_html(get_theme_mod('feature_2_title', 'Unlock Property Value')); ?>
                </h3>
            </div>
...
<stop offset="0.576615" stop-color="#A685FA" stop-opacity="0"/>
                ...
                <h3 class="feature-title">
                    <?php echo esc_html(get_theme_mod('feature_3_title', 'Effortless Property Management')); ?>
                </h3>
            </div>
...
<stop offset="0.576615" stop-color="#A685FA" stop-opacity="0"/>
                ...
                <h3 class="feature-title">
                    <?php echo esc_html(get_theme_mod('feature_4_title', 'Smart Investments, Informed Decisions')); ?>
                </h3>
            </div>
        </div>
    </div>
