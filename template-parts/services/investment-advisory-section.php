...
<section class="services-investment-advisory-section">
    <div class="container">
        <div class="investment-service-layout">
            ...
            <div class="investment-service-right">
                <div class="investment-cards-grid">
                    <div class="investment-cards-row">
                                    ...
                                    <div class="service-icon-inner">
                                        <div class="service-icon">
                                            <svg width="34" height="34" viewBox="0 0 34 34" fill="none">
                                                <rect x="4.25" y="3.19" width="25.5" height="27.62" fill="#A685FA"/>
                                            </svg>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="service-card-header">
                                <div class="service-icon-wrapper">
                                    <div class="service-icon-inner">
                                        <div class="service-icon">
                                            <svg width="34" height="34" viewBox="0 0 34 34" fill="none">
                                                <rect x="4.25" y="2.81" width="25.5" height="28" fill="#A685FA"/>
                                            </svg>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="service-card-header">
                                <div class="service-icon-wrapper">
                                    <div class="service-icon-inner">
                                        <div class="service-icon">
                                            <svg width="34" height="34" viewBox="0 0 34 34" fill="none">
                                                <rect x="5.31" y="1.06" width="23.38" height="31.88" fill="#A685FA"/>
                                            </svg>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="service-card-header">
                                <div class="service-icon-wrapper">
                                    <div class="service-icon-inner">
                                        <div class="service-icon">
                                            <svg width="34" height="34" viewBox="0 0 34 34" fill="none">
                                                <rect x="3.19" y="3.19" width="27.62" height="27.62" fill="#A685FA"/>
                                            </svg>
                                        </div>
                                    </div>
                                </div>
