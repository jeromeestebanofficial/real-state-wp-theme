...
<section class="services-property-selling-section">
    <div class="container">
                    ...
                    <div class="service-card-header">
                        <div class="service-icon-wrapper">
                            <div class="service-icon-inner">
                                <div class="service-icon">
                                    <svg width="34" height="34" viewBox="0 0 34 34" fill="none">
                                        <rect x="4.25" y="2.12" width="25.5" height="29.75" fill="#A685FA"/>
                                    </svg>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="service-card-header">
                        <div class="service-icon-wrapper">
                            <div class="service-icon-inner">
                                <div class="service-icon">
                                    <svg width="34" height="34" viewBox="0 0 34 34" fill="none">
                                        <rect x="3.19" y="3.19" width="27.62" height="27.15" fill="#A685FA"/>
                                    </svg>
                                </div>
                            </div>
                        </div>
